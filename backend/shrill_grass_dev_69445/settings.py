"""
Django settings for shrill_grass_dev_69445 project.
...
ROOT_URLCONF = 'shrill_grass_dev_69445.urls'
...
WSGI_APPLICATION = 'shrill_grass_dev_69445.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_grass_dev_69445 API",
    "DESCRIPTION": "API documentation for shrill_grass_dev_69445 App",
    "VERSION": "v1",
}
